#=============================================================================================================================
# Script Name:     Set-WingetUpgrade.ps1
...
$TaskFolder = 'Ucorp'
$TaskName = 'WingetUpgrade'
$RegCheck = 'WingetUpgrade'
$version = 1
$RegRoot= "HKLM"
...
if((!($regexist)) -or ($regexist.$RegCheck -lt $Version)){
    try{
        ...
        try{
            ...
            Register-ScheduledTask  -TaskName "$TaskFolder\$TaskName" -InputObject $D -ErrorAction Stop -Force
