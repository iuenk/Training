#=============================================================================================================================
# Script Name:     IMELogsCleanup_Remediate.ps1
# Description:     Remediation script of Proactive Remediation script to clean up IME logs.
#
# Notes      :     Remediation script of Proactive Remediation script to clean up IME logs.
#
# Created by :     Ivo Uenk
# Date       :     15-05-2026
# Version    :     1.0
...
<#
.SYNOPSIS
  Recursively list files from a location, skipping files whose *names* start with specified prefixes.
...
foreach($path in $OldLogs.FullName)

{
        Remove-Item -LiteralPath $path -ErrorAction SilentlyContinue
        Write-Host "$($Countofoldlogs) Logs removed"
}