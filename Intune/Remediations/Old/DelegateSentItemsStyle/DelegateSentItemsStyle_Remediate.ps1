#=============================================================================================================================
# Script Name:     DelegateSentItemsStyle_Remediate.ps1
...
$EC = @()
$ScriptName = 'DelegateSentItemsStyle_Remediate'
...
ForEach ($SID in $SIDs) {
    ...
    Write_Log -Message_Type "INFO" -Message "[$RegKeyDelegateSentItemsStyle : $GetUserDelegateSentItemsStyle]"
    If ($GetUserDelegateSentItemsStyle -ne $RegValueDelegateSentItemsStyle) {
        Write_Log -Message_Type "INFO" -Message 'Remediate'
        Set-ItemProperty -Path Registry::HKEY_USERS\$RegPath -Name $RegKeyDelegateSentItemsStyle -Value $RegValueDelegateSentItemsStyle -Type DWord
    } 
}
